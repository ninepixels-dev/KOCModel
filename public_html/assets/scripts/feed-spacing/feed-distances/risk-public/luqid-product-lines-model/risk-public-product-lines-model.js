        ...
        link: function (scope, elem, attr, ctrl) {
            scope.doCalculation = function () {
                ...
                $("#myModal").on('shown.bs.modal', function () {
                    ...
                    var Excel_File = Excel.Workbooks.Open("http://kuwait.ninepixels.rs/workbooks/liquid_product_pipelines_public.xlsx");
                    ...
                    var Excel_Templates = Excel.Workbooks.Open("http://kuwait.ninepixels.rs/workbooks/templates/Liquid Results Public.xlsx");
...
angular.module('fieldSpacingTool.publicProductLinesModel', [])
        .directive('publicProductLinesModel', publicProductLinesModel);