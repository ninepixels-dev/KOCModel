        ...
        link: function (scope, elem, attr, ctrl) {
            scope.doCalculation = function () {
                ...
                $("#myModal").on('shown.bs.modal', function () {
                    ...
                    var Excel_File = Excel.Workbooks.Open("http://kuwait.ninepixels.rs/workbooks/gaslines_model.xlsx");
                    ...
                    var Excel_Templates = Excel.Workbooks.Open("http://kuwait.ninepixels.rs/workbooks/templates/Gas Line Results.xlsx");
...
angular.module('fieldSpacingTool.plantGasLinesModel', [])
        .directive('plantGasLinesModel', plantGasLinesModel);